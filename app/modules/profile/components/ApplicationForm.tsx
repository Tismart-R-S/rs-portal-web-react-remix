...
import { applicationFormValidator } from "../utils/appilcation-from-validator";
import { Form } from "~/shared/components";
import { ApplicationFormValidationType } from "../types/application-form";
import { Save } from "lucide-react";
import { Controller } from "react-hook-form";

const ApplicationForm = () => {
  const initialValues: ApplicationFormValidationType = {
    country: "",
    city: "",
    documentType: "",
    documentNumber: "",
        ...
        return (
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              ...
              <div className="flex flex-col space-y-1.5">
                <Label htmlFor="yearsExeperience">Años de experiencia</Label>
                <Field name="yearsExeperience">
                  {({ Errors }) => (
                    <>
                      <Input
                        autoComplete="off"
